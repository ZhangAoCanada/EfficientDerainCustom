...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type = str, default = './results/results_tmp', help = 'save the generated with certain epoch')
    parser.add_argument('--load_name', type = str, default = './models/ours/KPN_rainy_image_epoch250_bs4.pth', help = 'load the pre-trained model with certain epoch')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '../dataset', help = 'images baseroot')
