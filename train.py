...
if __name__ == "__main__":
    ...
    parser.add_argument('--crop_size_h', type = int, default = 256, help = 'single patch height size')
    parser.add_argument('--crop_size_w', type = int, default = 256, help = 'single patch width size')
